	...
	<div class="wrap">
		<div class="card shadow">
			<div class="card-body">
				...
				@endif
				<form action="{{ route('students.update', $edit_data -> id) }}" method="POST" enctype="multipart/form-data">
					@csrf
					@method('PUT')
					...
					<div class="form-group">
						<img style="max-width: 100px" src=" {{URL::to('')}}/media/students/{{$edit_data -> photo}} ">
					...
					<div class="form-group clearfix">
						...
						<a class="btn btn-primary float-right" href="{{ route('students.show', $edit_data -> id) }}">Back</a>
					</div>
