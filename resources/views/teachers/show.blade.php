	...
	<div class="row d-flex justify-content-center">
		<div class="col-md-10 pt-3">
			<div class="row z-depth-3">
				<div class="col-sm-4 bg-info rounded-left">
					<div class="card-block text-center text-white">
						<img style="max-width: 200px; height: 200px; border-radius: 50%; margin-top: 20px" src="{{URL::to('')}}/media/teachers/{{$profile -> photo}}" alt="">
						<h2 class="font-weight-bold mt-4">{{$profile -> name}}</h2>
						<p>Student</p>
						<a href=" {{ route('teachers.edit', $profile -> id) }} " class="text-white"><i class="far fa-edit fa-2x mb-4"></i></a>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<form action="{{route('teachers.delete', $profile -> id)}}" method="POST">
						@csrf
						@method('DELETE')
